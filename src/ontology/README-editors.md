These notes are for the EDITORS of omrse
...
Make sure you have an ID range in the [idranges file](omrse-idranges.owl)

If you do not have one, get one from the maintainer of this repo.

The editors version is [omrse-edit.owl](omrse-edit.owl)

** DO NOT EDIT omrse.obo OR omrse.owl in the top level directory **

[../../omrse.owl](../../omrse.owl) is the release version

To edit, open the file in Protege. First make sure you have the repository cloned, see [the GitHub project](https://github.com/matentzn/omrse-odk-test) for details.
 ...
 * [omrse-idranges.owl](omrse-idranges.owl)
...
There are two ways to include new classes in an import module
 ...
 2. Add to the imports/omrse_terms.txt file
...
Note: the omrse_terms.txt file may include 'starter' classes seeded from
...
This generates derived files such as omrse.owl and omrse.obo and places
 ...
 * https://github.com/matentzn/omrse-odk-test/releases
 * https://github.com/matentzn/omrse-odk-test/releases/new
...
what is in the `owl:versionIRI` of the derived omrse.owl (`data-version` in
omrse.obo). This will be today's date.
 ...
 * http://purl.obolibrary.org/obo/omrse.owl <-- current ontology PURL
 * http://purl.obolibrary.org/obo/omrse/releases/YYYY-MM-DD.owl <-- change to the release you just made

For questions on this contact Chris Mungall or email obo-admin AT obofoundry.org

# Travis Continuous Integration System

Check the build status here: [![Build Status](https://travis-ci.org/matentzn/omrse-odk-test.svg?branch=master)](https://travis-ci.org/matentzn/omrse-odk-test)

Note: if you have only just created this project you will need to authorize travis for this repo.

 1. Go to [https://travis-ci.org/profile/matentzn](https://travis-ci.org/profile/matentzn)
 2. click the "Sync account" button
 3. Click the tick symbol next to omrse-odk-test
