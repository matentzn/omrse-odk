 ...
 * [omrse.yml](omrse.yml)
     * Determines how your purl.obolibrary.org/obo/omrse/ redirects will be handled
     ...
     * Paste in the contents of [omrse.yml](omrse.yml)
 ...
 * [omrse.md](omrse.md)
     ...
     * Paste in the contents of [omrse.md](omrse.md)
     * Click "Commit new file"
     * IMPORTANT: remember to make a pull request
     * An OBO admin will merge your Pull Request *providing it meets the requirements of the OBO library*
